 ...
 *
 * Generated on Fri Nov  4 13:39:04 2011,
 ...
 *****************************************************************************/
#include "cdtext_crc.h"     /* include the header file generated with pycrc */
#include <stdint.h>
#include <stdlib.h>
 ...
 *****************************************************************************/
static const cdtext_crc_t cdtext_crc_table[256] = {
			       ...
			       size_t data_len)
{
    ...
    while (data_len--) {
        ...
        crc = (cdtext_crc_table[tbl_idx] ^ (crc << 8)) & 0xffff;
